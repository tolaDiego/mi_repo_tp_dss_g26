...
//    }
//
//    public double retornarPuntos(@NotNull String tipopersona, int id) {
//        double puntos = -1;
//        if (tipopersona.equals("HUMANO")) {
//            puntos = retornarHumanoPorId(id).calcularPuntos();
//
//        }
//        if (tipopersona.equals("JURIDICA")) {
//            puntos = retornarJuridicaPorId(id).calcularPuntaje();
//        }
//
//        return puntos;
//    }
